var RelationAutoCompleteSelector = Class.create({
  ...
  add_token_from_li: function(item) {
    ...
    this.add_token(li_data.id, (li_data[keys[0]] ? li_data[keys[0]] : [])[this.queryParam] || li_data[this.queryParam], (li_data[keys[0]] ? li_data[keys[0]] : []) [this.idQueryParam] || li_data[this.idQueryParam]);
  },
